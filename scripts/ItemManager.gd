...
func load_weapons_database():
	weapons_database = {
		"iron_sword": {
			...
			"attack_speed": 1.0,
			"attack_range": 50,
			"icon_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_long_7.png",
			"sprite_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_long_7.png",
		...
		"elven_greatsword": {
			...
			"attack_speed": 1.0,
			"attack_range": 50,
			"icon_path": "res://Assets/oubliette_weapons - free/spr_wep_wood_bsw_3.png",
			"sprite_path": "res://Assets/oubliette_weapons - free/spr_wep_wood_bsw_3.png",
			"description": "A rare Elven weapon used by their champions",
			"rarity": "legendary",
			"stackable": false,
			"max_stack": 1,
			"weapon_scale": 3.0
		...
		"iron_buster_sword": {
			"id": "iron_buster_sword",
			"name": "Thick Iron Sword",
			"type": "weapon",
			"damage": 4.5,
			"attack_speed": 0.5,
			"attack_range": 50,
			"icon_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_large_7.png",
			"sprite_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_large_7.png",
			"description": "A basic iron sword",
			"rarity": "rare",
			"stackable": false,
			"max_stack": 1,
		...
		"scythe": {
			"id": "scythe",
			"name": "Rudimentary Scythe",
			"type": "weapon",
			"damage": 4.5,
			"attack_speed": 0.7,
			"attack_range": 50,
			"icon_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_scythe_0.png",
			"sprite_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_scythe_0.png",
			"description": "Rudimentary Scythe, nothing special about it",
			"rarity": "rare",
			"stackable": false,
			"max_stack": 1,
			"weapon_scale": 2.5
		...
		"iron_katanna": {
			...
			"attack_speed": 1.0,
			"attack_range": 55,
			"icon_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_katana_1.png",
			"sprite_path": "res://Assets/oubliette_weapons - free/spr_wep_iron_katana_2.png",
			"description": "A basic iron katanna said to be used by elite warriors",
			"rarity": "rare",
			"stackable": false,
			"max_stack": 1,
			"weapon_scale": 2.5
